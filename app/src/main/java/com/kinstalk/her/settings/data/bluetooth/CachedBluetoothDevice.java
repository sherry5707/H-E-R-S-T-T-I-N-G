...
public final class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    static final String ACTION_CONNECTION_STATE_CHANGED = "connection_state_changed";
    ...
    private String describe(LocalBluetoothProfile profile) {
        if (profile != null) {
            Log.d(TAG, "describe profile : " + profile.toString());
        } else {
            Log.d(TAG, "describe profile : null");
        }
    ...
    void onProfileStateChanged(LocalBluetoothProfile profile, int newProfileState) {
        ...
        if (newProfileState == BluetoothProfile.STATE_CONNECTED) {
            if (profile instanceof MapProfile) {
                ...
                ArrayList<LocalBluetoothProfile> toRemoves = new ArrayList<>();
                for(LocalBluetoothProfile oldProfile : mProfiles) {
                    if(oldProfile.toString().equals(profile.toString())) {
                        toRemoves.add(oldProfile);
                    }
                }
                for(LocalBluetoothProfile toRemoveProfile : toRemoves) {
                    mProfiles.remove(toRemoveProfile);
                }
                mRemovedProfiles.remove(profile);
                mProfiles.add(profile);
   ...
   public int getProfileConnectionState(LocalBluetoothProfile profile) {
    ...
    public boolean isNoBond() {
        return mDevice.getBondState() == BluetoothDevice.BOND_NONE;
    }
   ...
   public boolean isConnected() {
    ...
    void onBondingStateChanged(int bondState) {
        Log.d(TAG, "onBondingStateChanged: bondState = " + bondState);
        ...
        if (bondState == BluetoothDevice.BOND_BONDED) {
            Log.d(TAG, "mConnectAfterPairing = " + mConnectAfterPairing);
   ...
   public void unregisterCallback(Callback callback) {
    ...
    public interface Callback {
        void onDeviceAttributesChanged(CachedBluetoothDevice device);
    }
    ...
    public void setLocalConnected(boolean connected) {
    ...
    public void setManualConnect(boolean connect) {
        isManualConnect = connect;
    }
