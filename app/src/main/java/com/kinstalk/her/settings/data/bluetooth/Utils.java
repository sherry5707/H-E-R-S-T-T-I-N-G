...
public final class Utils {
    ...
    public static int getA2dpMode(Context context) {
        int isSinkEnabled = Settings.System.getInt(context.getContentResolver(), BluetoothConstants.A2DP_SINK_MODE_STRING, 0);
        if (isSinkEnabled == 1) {
    ...
    public static void setA2dpMode(Context context, int mode) {
        Settings.System.putInt(context.getContentResolver(), BluetoothConstants.A2DP_SINK_MODE_STRING,
                mode == BluetoothConstants.A2DP_SINK_MODE ? 1 : 0);
    }
    /**
